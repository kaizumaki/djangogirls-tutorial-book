...
//quote{
もしあなたがこのチュートリアルを１人ですすめていて、質問できるコーチが周りにいない時は、ここにチャットを用意しています：@<href>{https://gitter.im/DjangoGirls/tutorial,//image[tutorial][Gitter]{
//\}
} これまでにワークショップに参加したことがある方やコーチの皆さんが、このチャットで助けてくれることでしょう。 心配せずに、質問をなげかけてみてくださいね！

//}


それでは、@<href>{./how_the_internet_works/README.md,さっそく最初からやってみよう！}


== 自分の家でチュートリアルを進める


Django Girlsのワークショップに参加することはすばらしいことです。でも、いつも参加できるとは限らないですよね。 でしたら、ご自宅でこのチュートリアルに取り組むことをおすすめします。 ご自宅で取り組まれる方向けに、チュートリアルを一人で進めやすくする動画の準備を進めています。 動画の準備は進行中ですが、YouTubeチャンネル @<href>{https://www.youtube.com/channel/UC0hNd2uW8jTR5K3KBzRuG2A/feed,Coding is for girls} ですぐにますます多くのことがカバーされるでしょう。
...
このチュートリアルは、@<href>{https://djangogirls.org/,DjangoGirls} がメンテナンスしています。 ミスを見つけたりチュートリアルを更新したくなった時は、@<href>{https://github.com/DjangoGirls/tutorial/blob/master/README.md,コントリビューション・ガイドライン}を読んでください。
...
あなたが翻訳したい言語が @<href>{https://crowdin.com/,crowdin} にない時は、@<href>{https://github.com/DjangoGirls/tutorial/issues/new,新しい issue を立て}て、追加したい言語を私たちに教えてください。
